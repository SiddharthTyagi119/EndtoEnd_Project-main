...
#defining the things related to current model
    def __init__(self,
        ...
        #because to get new data to train new model
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            #checking accuracy is high or low
            #our latest dir is not created if the model accuracy is low than the previous model
